...
Namespace Themes
    Class XinBrowserOrangeTheme
        ...
        Public Overrides ReadOnly Property ButtonSelectedGradientBegin() As Color
            Get
                Return Color.FromArgb(255, 252, 171, 122)
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property ButtonPressedGradientBegin() As Color
            Get
                Return Color.FromArgb(255, 250, 132, 61)
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property ImageMarginGradientBegin() As Color
            Get
                Return Color.FromArgb(255, 238, 130, 64)
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property ImageMarginGradientEnd() As Color
            Get
                Return Color.FromArgb(255, 237, 121, 52)
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property MenuItemSelected() As Color
            Get
                Return Color.FromArgb(255, 251, 151, 85)
            End Get
        End Property
        Public Overrides ReadOnly Property MenuItemBorder() As Color
            Get
                Return Color.FromArgb(255, 252, 175, 124)
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property MenuItemSelectedGradientBegin() As Color
            Get
                Return Color.FromArgb(255, 253, 190, 149)
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property MenuItemPressedGradientBegin() As Color
            Get
                Return Color.FromArgb(255, 250, 130, 50)
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property ToolStripBorder() As Color
            Get
                Return Color.FromArgb(255, 163, 67, 3)
            End Get
        End Property
        Public Overrides ReadOnly Property ToolStripDropDownBackground() As Color
            Get
                Return Color.FromArgb(255, 252, 157, 95)
            End Get
        End Property
